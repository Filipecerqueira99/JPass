...
public class Aes256Test {
    ...
    // Filipe tests
    @ParameterizedTest
    @MethodSource("encryptBoundaryOffpoints")
    public void shouldEncryptBoundaryAnalysis(byte[] inBlock, int inIndex, byte[] outBlock, int outIndex) {
        byte[] key = {(byte) 0x00, (byte) 0x01, (byte) 0x02, (byte) 0x03, (byte) 0x04, (byte) 0x05, (byte) 0x06,
                (byte) 0x07, (byte) 0x08, (byte) 0x09, (byte) 0x0a, (byte) 0x0b, (byte) 0x0c, (byte) 0x0d, (byte) 0x0e,
                (byte) 0x0f, (byte) 0x10, (byte) 0x11, (byte) 0x12, (byte) 0x13, (byte) 0x14, (byte) 0x15, (byte) 0x16,
                (byte) 0x17, (byte) 0x18, (byte) 0x19, (byte) 0x1a, (byte) 0x1b, (byte) 0x1c, (byte) 0x1d, (byte) 0x1e,
        ...
        Aes256 cipher = new Aes256(key);
//        cipher.encrypt(inBlock, inIndex, outBlock, outIndex);
        try {
            cipher.encrypt(inBlock, inIndex, outBlock, outIndex);
        }
...
//        assertEquals("Cannot invoke \"String.toCharArray()\" because \"value\" is null", exception.getMessage());
    ...
    private static Stream<Arguments> encryptBoundaryOffpoints() {
        byte[] inBlock_16 = {(byte) 0x00, (byte) 0x11, (byte) 0x22, (byte) 0x33, (byte) 0x44, (byte) 0x55, (byte) 0x66,
                (byte) 0x77, (byte) 0x88, (byte) 0x99, (byte) 0xaa, (byte) 0xbb, (byte) 0xcc, (byte) 0xdd, (byte) 0xee,
                (byte) 0xff};
        byte[] inBlock_15 = {(byte) 0x00, (byte) 0x11, (byte) 0x22, (byte) 0x33, (byte) 0x44, (byte) 0x55, (byte) 0x66,
                (byte) 0x77, (byte) 0x88, (byte) 0x99, (byte) 0xaa, (byte) 0xbb, (byte) 0xcc, (byte) 0xdd, (byte) 0xee};

        byte[] outBlock = new byte[inBlock_16.length];
        byte[] outBlock_minus_1 = new byte[inBlock_16.length - 1];

        return Stream.of(
                arguments(inBlock_16, 0, outBlock, 0),
                arguments(inBlock_15, 0, outBlock, 0), // Expected: ArrayIndexOutOfBoundsException
                arguments(inBlock_16, -1, outBlock, 0), // Expected: ArrayIndexOutOfBoundsException
                arguments(inBlock_16,  inBlock_16.length - 16, outBlock, 0),
                arguments(inBlock_16, inBlock_16.length - 15, outBlock, 0), // Expected: ArrayIndexOutOfBoundsException
                arguments(inBlock_16, 0, outBlock_minus_1, 0), // Expected: ArrayIndexOutOfBoundsException
                arguments(inBlock_16, 0, outBlock, -1), // Expected: ArrayIndexOutOfBoundsException
                arguments(inBlock_16, 0, outBlock, outBlock.length - 16),
                arguments(inBlock_16, 0, outBlock, outBlock.length - 15) // Expected: ArrayIndexOutOfBoundsException
        );
    }
}
